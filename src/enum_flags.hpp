...
#define ENUM_FLAG_UNARY_OPERATOR(EnumType, Operator) \
    [[nodiscard]] inline constexpr auto operator Operator(EnumType lhs) noexcept -> EnumType { \
...
#define ENUM_FLAG_BINARY_OPERATOR(EnumType, Operator) \
    [[nodiscard]] inline constexpr auto operator Operator(EnumType lhs, EnumType rhs) noexcept -> EnumType { \
...
#define ENUM_FLAG_IN_PLACE_BINARY_OPERATOR(EnumType, Operator) \
    inline auto operator Operator(EnumType &lhs, EnumType rhs) noexcept -> EnumType& { \
